...
const model = new ml.linear_model.LogisticRegression();

async function training() {
  const xsData = tf.util.toNestedArray([N * 2, 2], xs.dataSync());
  const ysData = tf.util.toNestedArray([N * 2], ys.dataSync());
